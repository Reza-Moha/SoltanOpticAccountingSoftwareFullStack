...
const Dropdown = ({ user }) => {
  ...
  return (
    <div className="inline-block">
      ...
      {isOpen && (
        <div className="origin-top-right absolute left-0 top-14 mt-2 pb-2 w-52 rounded-lg shadow-lg bg-secondary-50 ring-1 ring-black ring-opacity-5 px-2 text-secondary-800 px-5">
          <ul
            role="menu"
